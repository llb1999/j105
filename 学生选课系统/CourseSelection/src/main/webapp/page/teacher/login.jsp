...
<div id="tab">
  ...
  <ul class="tab_menu">
    ...
    <a href="/page/teacher/login.jsp"><li class="selected" style="width:33%;">教师登录</li></a>
    <a href="/page/admin/login.jsp"><li style="width:34%;">管理员登录</li></a>
  </ul>
  <div class="tab_box">
   <!-- 导师登录开始-->
    <div>
     <div class="msg_box">${msg}</div>
      <form action="/teacher/teacherLogin.do" method="post" class="tea_login_error">
        <div id="username">
          <label>教工号：</label>
          <input type="text" id="tea_tea_id_hide" name="tea_id"/>
       ...
       <!-- <div id="code">
          ...
          <img src="../../img/captcha.jpg" alt="验证码占位图"/> </div>-->
        <div id="remember">
          <label></label>
        </div>
        <div id="login">
